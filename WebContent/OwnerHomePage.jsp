    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="PostItem.jsp">NewPost</a></li>
         <li><form class="homesearchpadding" id="searchform" action="/Rent_It/search">
	      				...
	      				<div class="panel panel-primary">
	        				 ...
	        				 <div class="panel-body"><img src="${itemelement.item_image_url}" class="img-responsive" style="height:200px" alt="Image"></div>
	       					 ...
	       					 <div class="panel-footer">Post Status : <c:out value = "${itemelement.item_status}"/><br>
		       					...
		       					<a id="editpostbutton" class="btn-submitpost" href="FetchPostServlet?item_id=${itemelement.item_id}">Edit</a>
