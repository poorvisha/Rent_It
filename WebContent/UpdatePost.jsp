...
<h3>Update Your Post !!!</h3>
	<div>
		<form id="post_item_form" action="UpdatePostServlet" method="post" enctype="multipart/form-data">
			<table id="post_item" align="center">
				<tr>
					<td>Title*</td>
					<td><input type="text" name="item_name" id="item_name"
						size="40" maxlength="30" value="${itemelement.item_name}" /></td>
				</tr>
				<tr>
					<td >Description*</td>
					<td><textarea rows="2" cols="38.5" name="item_description"
						id="item_description" size="40" maxlength="150"><c:out value = "${itemelement.item_description}"/></textarea></td>
				...
				<td>Item Image</td>
				<td>
                  	 <img name="profilepic" id="profilepic" alt="ItemImage" align="center" src="${itemelement.item_image_url}" width="100" height="100">
				...
				<tr>
					<td>Category*</td>
					<td><input type="text" name="item_category" id="item_category"
						size="40" maxlength="30" value="${itemelement.item_category}"/></td>
				</tr>
				<tr>
					<td>Zipcode*</td>
					<td><input type="text" name="zipcode" id="zipcode" size="30"
						maxlength="9" value="${itemelement.item_zipcode}"></td>
				</tr>
				<tr>
					<td>Cost per day*</td>
					<td><input type="text" name="daycost" id="daycost" size="30"
						maxlength="9" value="${itemelement.item_costperday}"></td>
				</tr>
				<tr>

					<td>Availability From*</td>
					<td><input id="available_from" name="available_from"
						type="date" value="${itemelement.item_available_from}" /></td>

					<td> To*<input
						id="available_to" name="available_to" type="date"
						value="${itemelement.item_available_to}" /></td>
				</tr>
				<tr>
					<td>Pick Up Location*</td>
					<td><input type="text" name="addressline1" id="addressline1"
						placeholder="Street Address" size="30" maxlength="40"  value="${itemelement.pickup_address}"/></td>
					<td><input type="text" name="city" id="city"
						placeholder="City" size="30" value="${itemelement.pickup_city}"></td>
				</tr>
				<tr>
					<td></td>
					<td><input type="text" name="state" id="state"
						placeholder="State" size="30" value="${itemelement.pickup_state}"></td>
				</tr>
				<tr>
					<td>Contact*</td>
					<td><input type="text" name="contact" id="contact"
						placeholder="555-555-5555" size="30" value="${itemelement.contact}"></td>
				</tr>
				<input type="hidden" id="item_id" name="item_id" value="${itemelement.item_id}"/>
				<tr>
					<td></td>
					<td></td>
					<td><input class= "btn-submitpost" type="submit" name="submit" value="Update"></td>               
				</tr>
