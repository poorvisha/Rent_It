...
<c:forEach items="<%=request.getAttribute(\"itemVOList\") %>" var="itemelement">    
  <tbody>
    <tr>
      <td><c:out value = "${itemelement.item_id}"/></td>
      <td><a href="ItemDetailServlet?item_id=<c:out value = "${itemelement.item_id}"/>"><c:out value = "${itemelement.item_name}"/></a></td>
      <td><c:out value = "${itemelement.item_description}"/></td>
      <td><c:out value = "${itemelement.item_zipcode}"/></td>
      <td><c:out value = "${itemelement.item_available_from}"/>  to  <c:out value = "${itemelement.item_available_to}"/></td>
      <td><c:out value = "$ ${itemelement.item_costperday}"/></td>
      <td><c:out value = "${itemelement.item_posteddate}"/></td>
    </tr>
