...
public class PostItemServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String item_name,item_description,item_image,zipcode,item_available_from,item_available_to,item_costperday,item_category,item_postedby,item_status,item_posteddate
				,pickup_addr,pickup_city,pickup_state,contact;
		...
		Date item_available_to_date = new SimpleDateFormat("yyyy-MM-dd").parse(item_available_to);
			...
			if(item_available_from_date.before(currentDate) || item_available_to_date.before(item_available_from_date)){
		...
		try {
			status = PostedItemsDAO.insertNewPost(item_name, 
					item_description, item_image, zipcode, item_available_from, item_available_to, item_costperday, 
					item_category, item_postedby, item_status, item_posteddate,pickup_addr,pickup_city,pickup_state,filePart,contact);
